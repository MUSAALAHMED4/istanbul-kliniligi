          ...
          <div className="d-flex">
            ...
            {/* <div className="d-none d-sm-block">
              ...
              >
                ...
                <DropdownMenu>
                  <Link to="/create-visit"><DropdownItem>Visit</DropdownItem></Link>
                  <Link to="/individual-details"><DropdownItem>Individual</DropdownItem></Link>
                  <Link to="/create-family"><DropdownItem>Family</DropdownItem></Link>
                  <Link to="/create-volunteer"><DropdownItem>Volunteer</DropdownItem></Link>
                </DropdownMenu>
              </Dropdown>
