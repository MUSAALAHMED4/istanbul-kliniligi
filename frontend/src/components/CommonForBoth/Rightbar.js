        ...
        <SimpleBar style={{ height: "900px" }}>
          <div data-simplebar className="h-100">
            <div className="rightbar-title px-3 py-4">
              ...
              <h5 className="m-0">{t("Settings")}</h5>
            </div>
            ...
            <div className="p-4">
              <div className="radio-toolbar">
                <span className="mb-2 d-block">{t("Layouts")}</span>
                <input
                  type="radio"
                  id="radioVertical"
                  name="radioFruit"
                ...
                />
                <label htmlFor="radioVertical">{t("Vertical")}</label>
                {"   "}
                <input
                  type="radio"
                  id="radioHorizontal"
                ...
                />
                <label htmlFor="radioHorizontal">{t("Horizontal")}</label>
              </div>
              ...
              <div className="radio-toolbar">
                ...
                />{" "}
                <label htmlFor="radioFluid">{t("Fluid")}</label>
                {"   "}
                <input
                  type="radio"
                  id="radioBoxed"
                ...
                />{" "}
                <label htmlFor="radioBoxed">{t("Boxed")}</label>
              </div>
              <hr className="mt-1" />
              ...
              <div className="radio-toolbar">
                ...
                />
                <label htmlFor="radioThemeLight">{t("Light")}</label>
                {"   "}
                <input
                  type="radio"
                  id="radioThemeDark"
                ...
                <label htmlFor="radioThemeDark">{t("Dark")}</label>
                {"   "}
              </div>
              ...
              {props.layoutType === "vertical" ? (
                <React.Fragment>
                  ...
                  <div className="radio-toolbar">
                    ...
                    />
                    <label htmlFor="sidebarDefault">{t("Default")}</label>
                    {"   "}
                    <input
                      type="radio"
                      id="sidebarCompact"
                    ...
                    />
                    <label htmlFor="sidebarCompact">{t("Compact")}</label>
                    {"   "}
                    <input
                      type="radio"
                      id="sidebarIcon"
                    ...
                    />
                    <label htmlFor="sidebarIcon">{t("Icon")}</label>
                  </div>
                  ...
                  <div className="radio-toolbar">
                    ...
                    <label htmlFor="leftsidebarThemelight">{t("Light")}</label>
                    {"   "}
                    <input
                      type="radio"
                    ...
                    <label htmlFor="leftsidebarThemedark">{t("Dark")}</label>
                    {"   "}
                    <input
                      type="radio"
                    ...
                    <label htmlFor="leftsidebarThemecolored">{t("Colored")}</label>
                  </div>
                  <hr className="mt-1" />
                </React.Fragment>
              ) : null}

              <h6 className="text-center">{t("Choose Layouts")} </h6>
              ...
              <Link
                ...
                target="_blank"
              >
                <i className="mdi mdi-cart ms-1" /> {t("Purchase Now")}
              </Link>
              */}
